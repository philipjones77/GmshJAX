...
from smpljax import default_mode1_params, optimize_mode5
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Benchmark SMPLJAX Mode 5 dynamic-controller optimization.")
    ...
    first = optimize_mode5(
        model,
        params,
        cycles=2,
        surrogate_steps=2,
        refinement_steps=3,
        surrogate_step_size=0.05,
    ...
    payload = {
        ...
        "cycles": len(first.phase_summaries),
